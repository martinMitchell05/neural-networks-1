...
cabeceras = ['x1','x2','r']
tabla = pd.read_csv('XOR_trn.csv', header=None, names=cabeceras)
...
#print(w)
w = np.array([0.16952864, 0.12045091, 0.49776474]) 

tasa_aciertos = 0
w_historial = [w.copy()]

while epocas < epocas_max and tasa_aciertos<0.74:
...
if tasa_aciertos>=0.74:
    print(w)

#[-0.00134322 -0.00017824 -0.00123526]
