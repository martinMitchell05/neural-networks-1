...
cabeceras = ['x1','x2','r']
tabla = pd.read_csv('OR_50_trn.csv', header=None, names=cabeceras)
...
#print(w)
w = np.array([-0.0088388,  -0.33456546, -0.38132301]) 

tasa_aciertos = 0
w_historial = [w.copy()]

while epocas < epocas_max and tasa_aciertos<0.99:
...
#[ 0.1581139   0.11250984 -0.17132301]
